...
URL = "https://sjabdshb-7be11272492e.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://sjabdshb-7be11272492e.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://sjabdshb-7be11272492e.herokuapp.com/".format(FQDN)
else:
    URL = "https://sjabdshb-7be11272492e.herokuapp.com/".format(FQDN)
